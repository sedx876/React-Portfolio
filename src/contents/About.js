  ...
  render() {
    return (
      <div className="condiv">
        ...
        Pursuing my Software Engineering Degree at Flatiron School.  Web development is my center of interest. 
        I always love the idea of cross-platform development, 1-n one code base deploy into almost
